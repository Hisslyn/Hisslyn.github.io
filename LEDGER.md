...
| docs-index | process | PARTIAL | — | `docs/INDEX.md` exists on disk, but `docs/_manifest.json` holds `{"files": []}` — zero file entries — and no per-file docs are written under `docs/`. PARTIAL by design per the 2026-07-26 reconcile ruling |
