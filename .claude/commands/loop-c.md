---
description: Loop C — numbers. Derive one tuning table, STOP for your ruling, then apply it
argument-hint: [optional focus, e.g. a screen name or "DUMP MODE off"]
---

Read `loop-prompts/loopC.md` in full and execute it exactly as written. It is the
